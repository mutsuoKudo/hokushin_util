...
//                    var_dump($pc_list[0]['id']);
                    ...
                    print('<th colspan="7" class="top_cell_color3">所在情報等<form action="pc_list_print.php" target="_blank" method="get"><input type="hidden" name="shiteinumber" value="02">                    
                    <input type="hidden" name="shiteiroom" value="管理部">
